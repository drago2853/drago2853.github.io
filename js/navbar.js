...
<nav class="navigationWrapper" id="navbarElement">
    ...
    <div class="navigation listNavbarPages" id="contantDetails">
       <p class="fa fa-envelope-open link photoLarge" id="fName"><i class="listNavbarItem">danilo.mazic12@gmail.com</i></p>
       <p class="fa fa-phone-alt me-2 link photoLarge" id="mob1"><i class="listNavbarItem">+381 6286 07021</i></p>
       <p class="fa fa-phone-alt me-2 link photoLarge" id="mob2"><i class="listNavbarItem">Viber/WA: +49 170436 2889</i></p>
    </div>

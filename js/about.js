...
<div class="container-fluid bg-secondary p-0">
    <div class="row g-0">
        <div class="col-lg-6 py-6 px-5 smallMarginTopAboutUsTitle">
            <h1 class="display-5 mb-4">Dobrodosli u <span class="text-primary">Transport Evropom</span></h1>
            <h4 class="text-primary mb-4">Brz, pouzdan i ekonomičan transport</h4>
        ...
        <div class="col-lg-6 smallMarginTopAboutUsTitle" style="min-height: 500px;">
            <div class="position-relative h-100">
                <img class="position-absolute w-100 h-100 fitImage" src="img/1.jpg">
            </div>
        </div>
    </div>
</div>

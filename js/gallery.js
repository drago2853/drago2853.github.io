...
let gallerySecondSerbian = `

<div class="col-lg-4 mb-4 mb-lg-0">
<img data-src="img/13.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="Transport radne mašine na prikolici, kamion i prikolica sa strane" />

<img data-src="img/14.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="Transport bagera na prikolici, kamion i prikolica sa strane" />
</div>

<div class="col-lg-4 mb-4 mb-lg-0">
<img data-src="img/15.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport pickup-a na prikolici" />

<img data-src="img/16.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport pickup-a i auta na prikolici" />
</div>

<div class="col-lg-4 mb-4 mb-lg-0">
<img data-src="img/17.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport auta starijeg godišta na prikolici" />

<img data-src="img/18.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport kombija i auta na prikolici" />
</div>

<div class="col-lg-4 mb-4 mb-lg-0">
<img data-src="img/19.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport kombija i auta izbliza uslikano na prikolici" />

<img data-src="img/20.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport kombija i auta od pozadi uslikano na prikolici" />
</div>

<div class="col-lg-4 mb-4 mb-lg-0">
<img data-src="img/21.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport kombija i auta sa strane uslikano" />

<img data-src="img/22.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport dva auta na prikolici" />
</div>

<div class="col-lg-4 mb-4 mb-lg-0">
<img data-src="img/23.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="transport gradjevinskog materijala na prikolici" />

<img data-src="img/24.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="utovar gradjevinskog materijala na prikolicu" />
</div>

<div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
<img data-src="img/33.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy" alt="kamion sa desne strane" />

<img data-src="img/36.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy" alt="kamion sa leve strane" />
</div>

<div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
<img data-src="img/35.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy" alt="kamion sa prednje strane" />

<img data-src="img/34.jpg" class="w-100 shadow-1-strong rounded mb-4 lazy"
    alt="prevoz dva automobila na kamionu" />
</div>
`;
...
if(lang.indexOf("en") != -1) {
    ...
    document.getElementById("pageTitle").innerHTML = "Galerija";
}

setTimeout(function() {
    
    setCorrectLanguageAddHtml("galleryTemplateId2", gallerySecondSerbian, gallerySecondEnglish, gallerySecondGerman);
